...
//   const isOwner = lookbook.memberId === userId; // Check if the current user is the owner of the lookbook
//   const [commentList, setCommentList] = useState([]);
//   const [newComment, setNewComment] = useState('');
...
//             !isOwner &&
//             comment.memberId !== userId &&
//             !comment.replies.some((reply) => reply.memberId === userId)
//           ) {
//             return null; // 댓글도 자신이 쓴 것이 아니고, 답글도 자신이 쓴 것이 아니면 숨김
//           }
