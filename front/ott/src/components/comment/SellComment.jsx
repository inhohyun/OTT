...
const comments = [
  {
    ...
    content: '판매자 댓글입니다.',
    replies: [
      { id: 2, user: 'buyer1', content: '구매자1 댓글입니다.' },
      { id: 3, user: 'seller', content: '판매자 답글입니다.' },
    ],
  },
  {
    id: 4,
    user: 'buyer2',
    content: '구매자2 댓글입니다.',
    replies: [{ id: 5, user: 'seller', content: '판매자 답글입니다.' }],
  },
        ...
        <div key={comment.id} style={{ marginBottom: '20px' }}>
          <div>
            ...
            comment.user === 'seller' ? (
              ...
              <p>
                <strong>{comment.user}</strong>: <em>비공개 댓글입니다.</em>
              </p>
            )}
          </div>
              ...
              {comment.replies.map((reply) => (
                ...
                >
                  ...
                  comment.user === userRole ? (
                    ...
                    <p>
                      <strong>{reply.user}</strong>: <em>비공개 답글입니다.</em>
                    </p>
                  )}
                </div>
              ))}
