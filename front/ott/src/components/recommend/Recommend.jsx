...
// import { heightWeight } from '../../api/lookbook/recommend';

// const Recommend = () => {
//   const categories = ['키·몸무게', '체형', '선호 스타일'];
//   const [heightWeightRecommend, setHeigthWeightRecommend] = useState([]);
...
//       try {
//         const response = await heightWeight(memberId);
//         console.log('키,체형', response);
//         setHeigthWeightRecommend(response);
//       } catch (error) {
//         console.error(error);
//       }
//     };
