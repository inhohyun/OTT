...
const PersonSearchResult = ({ results, searchQuery }) => {
  ...
  useEffect(() => {
    ...
    const filtered = results.filter(result => 
      ...
      const aTitleIndex = a.title.toLowerCase().indexOf(searchQuery.toLowerCase());
      const aDescIndex = a.description.toLowerCase().indexOf(searchQuery.toLowerCase());
      const bTitleIndex = b.title.toLowerCase().indexOf(searchQuery.toLowerCase());
      const bDescIndex = b.description.toLowerCase().indexOf(searchQuery.toLowerCase());
